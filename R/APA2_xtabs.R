#' @name Kreuztabellen
#' @rdname Kreuztabellen
#' @title Kreuztabellen
#' @description Formatiert xtabs() 2x2 Tabellen werden mit Haufigkeit wahlweise mit Prozent
...
#' @param x xtabs Objekt geht aber auch mit table aber sollte wegen der Beschriftungen (labels) nicht verwendet werden.
