...
#' @name Korrelation
#' @description Diese Funktion erstellt Korrelationstabelle (Interkorrelationen mit hilfe
#' der Funktion \code{\link[Hmisc]{rcorr}}. Erlaubt ist die getrennte Auswertung ueber groups bzw mit by
#' siehe auch Beispiel unten.
#' Die Funktion arbeitet mit der Pipe oder auch mit Formeln.
#' @examples
#' n<- 2*8
#' e<- rnorm(n)*10
...
#' @rdname Korrelation
#' @description APA_Correlation arbeitet intern mit ser Funktion corr_tabel.
#' @param x Objekt data.frame oder formula
#' @param ... alles weiter zB namen der Variablen
#' @param caption,note Ueberschrift  Fussnote Korrelation
#' @export
APA_Correlation <-
  function(x, ...,
...
#' @rdname Korrelation
#' @description corr_tabel ist die interne Funktion die die Berechnungen erstellt
