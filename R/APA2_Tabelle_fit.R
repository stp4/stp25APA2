#' Regressions Tabelle
#'
#' Erstellt APA-Style Tabellen. Dabei koennen analog der Hmisc:summary Funktion mit Hilfe
#'  von Formeln deskriptive Auswertungen mit Signifikanz-Tests erstellt werden oder aber auch der Output
#'  vom aov un lm sowie glm
#'  entsprechend des APA-Style ausgegeben werden. Es kann sowohl Text als Auch HTML ausgegeben werden.
#' @name APA_Table
#' @rdname APA_Table
#' @param ... Modelle
...
#'
#' @return Output als html und data.frame mit den Ergebnissen
#' @export
#'
#' @examples
#'
...
APA_Table <- function(...,
                      ...
                      include.ci = NULL,
                      #Fehler abfangeb
                      include.CI = if (!is.null(include.ci))
                        include.ci
                      else
                        FALSE,
                      ...
                      if (type[1] == "default") {
                        ...
                        if ("broom" %in%  type) {
                          ...
                          result <- type_long(
                            ...
                            include.b=include.b,
                            include.ci =  include.CI,      #Fehller abfangen mit alter schreibweise
                            include.odds = include.odds,
                          ...
                          cat("\nunbekanner Parameter oder anova\n")
                        }
                      }


                      if ("anova" %in% type) {
                        result[["anova"]] <- APA_Table_Anova(myfits,
                                                             caption = caption,
                                                             note = note,
                                                             names=names,
